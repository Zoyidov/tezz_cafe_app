...
class UpdateCallBackBloc
    extends Bloc<UpdateCallBackEvent, UpdateCallBackState> {
  ...
  Future<void> _onUpdateCallBack(
      UpdateCallBack event, Emitter<UpdateCallBackState> emit) async {
