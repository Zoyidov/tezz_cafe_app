...
class InActiveToggleButtonsContainer extends StatelessWidget {
  const InActiveToggleButtonsContainer({super.key});
          ...
          child: SingleChildScrollView(
            ...
            child: ToggleButtons(
              ...
              onPressed: (index) {
                ...
                context.read<TableBloc>().add(ChangeTableEvent(index));
              },
