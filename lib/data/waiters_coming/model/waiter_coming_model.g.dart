...
_$WaiterComingModelImpl _$$WaiterComingModelImplFromJson(
        Map<String, dynamic> json) =>
    _$WaiterComingModelImpl(
...
Map<String, dynamic> _$$WaiterComingModelImplToJson(
        _$WaiterComingModelImpl instance) =>
    <String, dynamic>{
      '_id': instance.id,
      'name': instance.name,
