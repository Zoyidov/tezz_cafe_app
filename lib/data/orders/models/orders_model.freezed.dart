...
class _$OrdersModelImpl implements _OrdersModel {
  ...
  @override
  String toString() {
    return 'OrdersModel(id: $id, table: $table, waiter: $waiter, totalPrice: $totalPrice, restaurant: $restaurant, products: $products, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
...
abstract class _OrdersModel implements OrdersModel {
  const factory _OrdersModel(
      ...
      @JsonKey(name: "__v") required final int v}) = _$OrdersModelImpl;
