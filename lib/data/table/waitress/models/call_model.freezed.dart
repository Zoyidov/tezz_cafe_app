...
class _$CallModelImpl implements _CallModel {
  ...
  @override
  String toString() {
    return 'CallModel(id: $id, name: $name, callModelId: $callModelId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, callModelId);
...
abstract class _CallModel implements CallModel {
  const factory _CallModel(
          ...
          @JsonKey(name: "id") required final String callModelId}) =
      _$CallModelImpl;
